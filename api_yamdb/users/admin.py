...
from users.mixins import CustomEmptyMixin
from users.models import User
from reviews.models import Review, Comment
from titles.models import Categories, Genres, Title


class UserAdmin(CustomEmptyMixin, admin.ModelAdmin):
...
class ReviewAdmin(CustomEmptyMixin, admin.ModelAdmin):
...
class CommentAdmin(CustomEmptyMixin, admin.ModelAdmin):
...
class CategoriesAdmin(CustomEmptyMixin, admin.ModelAdmin):
...
class GenresAdmin(CustomEmptyMixin, admin.ModelAdmin):
...
class TitleAdmin(CustomEmptyMixin, admin.ModelAdmin):
